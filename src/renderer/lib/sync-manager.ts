...
import { abortSync, createCoverArtStore, createCoverManager, getUserInfo, login, logout, sync } from "#core";
import type { CoverArtFileSystem, CoverManager, CoverTarget, SyncMode, SyncRecord, UserCredentialsToLogin, UserInfo } from "#core";
